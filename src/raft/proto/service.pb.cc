...
const uint32_t TableStruct_service_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::MyRequest, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::MyRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::MyRequest, _impl_.msg_),
  0,
  PROTOBUF_FIELD_OFFSET(::MyResponse, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::MyResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::MyResponse, _impl_.msg_),
  0,
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 7, -1, sizeof(::MyRequest)},
  { 8, 15, -1, sizeof(::MyResponse)},
};
...
class MyRequest::_Internal {
 public:
  using HasBits = decltype(std::declval<MyRequest>()._impl_._has_bits_);
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "MyRequest.msg"));
        } else
          goto handle_unusual;
        continue;
      default:
...
class MyResponse::_Internal {
 public:
  using HasBits = decltype(std::declval<MyResponse>()._impl_._has_bits_);
  static void set_has_msg(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
};
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "MyResponse.msg"));
        } else
          goto handle_unusual;
        continue;
      default:
...
template<> PROTOBUF_NOINLINE ::MyRequest*
Arena::CreateMaybeMessage< ::MyRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::MyRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::MyResponse*
Arena::CreateMaybeMessage< ::MyResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::MyResponse >(arena);
}
